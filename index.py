...
st.markdown('''<span style="font-size: 25px;">This app is currently under maintenance as I am improving the app to make it more interactive and user-friendy. </span>''', unsafe_allow_html=True)
